...
INPUT_POINTER_SOURCES = (
    ...
    (
        "RightClickMenuExit",
        "src/main/java/featurecat/lizzie/gui/RightClickMenu.java",
        {"mouseExited"},
        {"mouseExited": 1},
    ),
)
...
def validate_matrix(
    ...
    if matrix.get("schema_version") != 37:
        raise ValueError("Matrix schema_version must be 37")
